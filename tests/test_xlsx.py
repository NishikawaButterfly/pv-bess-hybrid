...
class ExportXlsxCommandTests(unittest.TestCase):
    ...
    def test_export_writes_expected_sheets_and_key_cells(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            # The sample's discount rate is ordinary, so no Warnings section.
            self.assertNotIn("Warnings", column_a)
    ...
    @unittest.skipUnless(_OPENPYXL_AVAILABLE, _SKIP_REASON)
    def test_percentage_like_discount_rate_warning_reaches_the_workbook(self) -> None:
        from openpyxl import load_workbook
        ...
        self.assertTrue(
            any(isinstance(value, str) and "800%" in value for value in column_a),
