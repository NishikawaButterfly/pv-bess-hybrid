...
- The example annualizes one synthetic day and is not an investment case.
...
- A 100,000-row input limit does not guarantee that every accepted MILP will solve inside the default time limit.
